var zbp = new ZBP({
	bloghost: "http://nbhkg.com/blog/",
	ajaxurl: "http://nbhkg.com/blog/zb_system/cmd.php?act=ajax&src=",
	cookiepath: "/blog/"
});
...
$(document).ready(function(){
	...
	if ($("div.divHeader,div.divHeader2").first().css("background-image") == "none") { 
		AddHeaderIcon("image/common/window.png");
	}
	...
	if(s != undefined && s.indexOf("none.html") != -1 ){
